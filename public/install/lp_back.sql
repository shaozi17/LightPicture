...
VALUES (
        ...
        '1073741824.00',
        1,
        '7c63b59c638aa4a9e98144d9d929c18e',
        '',
        NULL,
        1642174012,
        1639712987
...
ALTER TABLE `osuu_code` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `osuu_images` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `osuu_log` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `osuu_role` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `osuu_storage` ADD PRIMARY KEY (`id`);
...
ALTER TABLE
    `osuu_code` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 18;
...
ALTER TABLE
    `osuu_images` MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
    AUTO_INCREMENT = 1284;
...
ALTER TABLE
    `osuu_log` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 455;
...
ALTER TABLE
    `osuu_role` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    AUTO_INCREMENT = 32;
...
ALTER TABLE
    `osuu_storage` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 1043;
...
ALTER TABLE
    `osuu_system` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 16;
...
ALTER TABLE
    `osuu_user` MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 41;
